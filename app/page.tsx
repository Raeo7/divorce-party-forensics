    ...
    <>
      ...
      <section>
        <div className="wrap">
          ...
          {reconciliations.map((r) => (
            <details className="decision" key={r.id} id={r.id} open>
      ...
      <section>
        <div className="wrap">
          <SectionHead id="trail" num="06" title="AI review trail" note={agentProtocol.method} />
          <div className="callout">
            <p>{agentProtocol.convergence}</p>
          </div>

          <h3 style={{ marginTop: 30, marginBottom: 6 }}>
          ...
          <p className="sec-note" style={{ gridColumn: "auto", marginBottom: 16 }}>
            ...
            alternative I rejected, and how confident I am. The full record for each follows below.
          </p>
      ...
      <section>
        <div className="wrap">
          <SectionHead id="board" num="09" title="Board recommendation" />
          <p
            style={{
